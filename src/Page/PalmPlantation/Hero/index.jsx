...
export default function index() {
  ...
  return (
    <div className="font-1">
      <div className="bg-hero-pattern md:pt-[10px] min-h-[100vh] pb-[100px] lg:pb-[212px]">
        <div className={` ${Container}  flex flex-col  h-full`}>
         ...
         <Header openModal={openModal} Text={"Invest Now"} />
          ...
          <button className="bg-white w-[fit-content] mx-auto text-center rounded-[56px] py-[10px] lg:py-[20px] px-[30px] lg:px-[48px] text-[#121212] text-[20px] lg:text-[28px] ">
            Invest Now
          </button>
          </div>
        </div>
