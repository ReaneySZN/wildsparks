...
export default function SuccessPage({
  ...
  return (
    <div className=" rounded-[32px] flex flex-col justify-center items-center  bg-white py-[80px] px-[80px]">
       
           <TickIcon/>
           <div className="mt-[32px] text-[32px] text-[#121212] font-semibold mb-[16px]">
           Thank you!
           </div>
           <div className="text-[#565656] text-[24px] text-center font-2 font-extralight leading-[28px] mb-[48px]">
